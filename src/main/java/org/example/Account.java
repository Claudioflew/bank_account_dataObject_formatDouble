...
public class Account {
    ...
    // dateCreated should be constant - read only
    ...
    // Constructor should not be responsible for input validation; Mutator should be.
    ...
    // These functions should be static. Non-static functions also can access static variables though..
    ...
    public double getMonthlyInterest() {
        ...
        // We want to truncate the 3rd decimal point.
        return (int)(balance * monthlyInterestRate * 100) / 100.0;
    }
